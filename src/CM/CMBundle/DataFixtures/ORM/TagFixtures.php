...
{
    private $tags = array(
    /*1*/    array('name-en' => 'pianist', 'name-fr' => 'pianiste', 'name-it' => 'pianista', 'type' => array(Tag::TYPE_USER, Tag::TYPE_PAGE_USER, Tag::TYPE_ENTITY_USER)),
    /*2*/    array('name-en' => 'violinist', 'name-fr' => 'violiniste', 'name-it' => 'violinista', 'type' => array(Tag::TYPE_USER, Tag::TYPE_PAGE_USER, Tag::TYPE_ENTITY_USER)),
    /*3*/    array('name-en' => 'cellist', 'name-fr' => 'violoncelliste', 'name-it' => 'violoncellista', 'type' => array(Tag::TYPE_USER, Tag::TYPE_PAGE_USER, Tag::TYPE_ENTITY_USER)),
    /*4*/    array('name-en' => 'double-bassist', 'name-fr' => 'contrebassiste', 'name-it' => 'contrabbassista', 'type' => array(Tag::TYPE_USER, Tag::TYPE_PAGE_USER, Tag::TYPE_ENTITY_USER)),
    /*5*/    array('name-en' => 'flautist', 'name-fr' => 'flûtiste', 'name-it' => 'flautista', 'type' => array(Tag::TYPE_USER, Tag::TYPE_PAGE_USER, Tag::TYPE_ENTITY_USER)),
    /*6*/    array('name-en' => 'oboist', 'name-fr' => 'hautboïste', 'name-it' => 'oboista', 'type' => array(Tag::TYPE_USER, Tag::TYPE_PAGE_USER, Tag::TYPE_ENTITY_USER)),
    /*7*/    array('name-en' => 'clarinettist', 'name-fr' => 'clarinettiste', 'name-it' => 'clarinettista', 'type' => array(Tag::TYPE_USER, Tag::TYPE_PAGE_USER, Tag::TYPE_ENTITY_USER)),
    /*8*/    array('name-en' => 'trumpeter', 'name-fr' => 'trompettiste', 'name-it' => 'trombettista', 'type' => array(Tag::TYPE_USER, Tag::TYPE_PAGE_USER, Tag::TYPE_ENTITY_USER)),
    /*9*/    array('name-en' => 'tenor', 'name-fr' => 'ténor', 'name-it' => 'tenore', 'type' => array(Tag::TYPE_USER, Tag::TYPE_PAGE_USER, Tag::TYPE_ENTITY_USER)),
    /*10*/    array('name-en' => 'music critic', 'name-fr' => 'critique de musique', 'name-it' => 'critico musicale', 'type' => array(Tag::TYPE_USER, Tag::TYPE_PAGE_USER, Tag::TYPE_ENTITY_USER)),
    /*11*/    array('name-en' => 'musicologist', 'name-fr' => 'musicologue', 'name-it' => 'musicologo', 'type' => array(Tag::TYPE_USER, Tag::TYPE_PAGE_USER, Tag::TYPE_ENTITY_USER)),
    /*12*/    array('name-en' => 'composer', 'name-fr' => 'compositeur', 'name-it' => 'compositore', 'type' => array(Tag::TYPE_USER, Tag::TYPE_PAGE_USER, Tag::TYPE_ENTITY_USER)),
    /*13*/    array('name-en' => 'director', 'name-fr' => 'directeur', 'name-it' => 'direttore', 'type' => array(Tag::TYPE_USER, Tag::TYPE_PAGE_USER, Tag::TYPE_ENTITY_USER)),
    ...
    /*39*/    array('name-en' => 'teacher', 'name-fr' => 'teacher', 'name-it' => 'insegnante', 'type' => array(Tag::TYPE_USER, Tag::TYPE_PAGE_USER, Tag::TYPE_ENTITY_USER)),
    /*40*/    array('name-en' => 'agent', 'name-fr' => 'agent', 'name-it' => 'agente', 'type' => array(Tag::TYPE_USER, Tag::TYPE_PAGE_USER, Tag::TYPE_ENTITY_USER)),
    /*41*/    array('name-en' => 'project manager', 'name-fr' => 'agent', 'name-it' => 'project manager', 'type' => Tag::TYPE_USER),
    /*42*/    array('name-en' => 'editor', 'name-fr' => 'agent', 'name-it' => 'redattore', 'type' => array(Tag::TYPE_USER, Tag::TYPE_PAGE_USER, Tag::TYPE_ENTITY_USER)),
