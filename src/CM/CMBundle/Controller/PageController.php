...
class PageController extends Controller
{
    ...
    public function wallAction(Request $request, $slug, $page = 1)
    {
        ...
        $posts = $em->getRepository('CMBundle:Post')->getLastPosts(array('pageId' => $publisher->getId()));
        ...
        return array('posts' => $pagination, 'page' => $publisher);
    }

    /**
     * @Route("/wall/{postId}/update", name="page_wall_update", requirements={"postId" = "\d+"})
