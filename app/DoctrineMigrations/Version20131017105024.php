 ...
 */
class Version20131017105024 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("CREATE TABLE page (id INT AUTO_INCREMENT NOT NULL, creator_id INT NOT NULL, type SMALLINT NOT NULL, name VARCHAR(150) NOT NULL, description VARCHAR(250) NOT NULL, website VARCHAR(150) NOT NULL, vip TINYINT(1) NOT NULL, slug VARCHAR(255) NOT NULL, createdAt DATETIME DEFAULT NULL, updatedAt DATETIME DEFAULT NULL, cover_img VARCHAR(100) DEFAULT NULL, cover_img_offset SMALLINT DEFAULT NULL, img VARCHAR(100) DEFAULT NULL, offset SMALLINT DEFAULT NULL, INDEX IDX_140AB62061220EA6 (creator_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        $this->addSql("CREATE TABLE page_user (id INT AUTO_INCREMENT NOT NULL, page_id INT NOT NULL, user_id INT NOT NULL, admin TINYINT(1) NOT NULL, join_event SMALLINT NOT NULL, join_disc SMALLINT NOT NULL, join_article SMALLINT NOT NULL, user_tags LONGTEXT DEFAULT NULL COMMENT '(DC2Type:array)', notification TINYINT(1) NOT NULL, createdAt DATETIME DEFAULT NULL, updatedAt DATETIME DEFAULT NULL, INDEX IDX_A57CA93C4663E4 (page_id), INDEX IDX_A57CA93A76ED395 (user_id), UNIQUE INDEX UNIQ_A57CA93C4663E4A76ED395 (page_id, user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        ...
        $this->addSql("CREATE TABLE user_user_tag (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, user_tag_id INT NOT NULL, `order` SMALLINT DEFAULT NULL, INDEX IDX_8123208A76ED395 (user_id), INDEX IDX_8123208DF80782C (user_tag_id), UNIQUE INDEX UNIQ_8123208A76ED395DF80782C (user_id, user_tag_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
