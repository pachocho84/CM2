 ...
 */
class Version20131216185000 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("CREATE TABLE disc (id INT NOT NULL, authors VARCHAR(150) NOT NULL, interpreters VARCHAR(150) NOT NULL, `label` VARCHAR(150) NOT NULL, year DATE NOT NULL, createdAt DATETIME DEFAULT NULL, updatedAt DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
